      ...
      <section className="pt-20 pb-32 px-4">
        <div className="container mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-bold text-foreground leading-tight pr-0">PropFirm Knowledge Trading  <span className="block text-primary">Journal Challenge</span>
            </h1>
            ...
            <Card className="bg-gradient-card shadow-card">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>Tag <Badge variant="secondary">@propfirm_forex</Badge> in your Twitter post</div>
                </div>
                <div className="flex items-start gap-3">
              ...
              <CardContent>
                <div className="bg-muted p-4 rounded-lg border-l-4 border-l-primary">
                  <p className="text-sm font-mono">
                    ...
                    #15DaysofTrading @propfirm_forex<br /><br />
